...
<div class="edit-eform-page">    
    <div class="row">
        <div class="col-12 text-right">
            <?=
            $this->Html->link(
                    __('<span><i class="fas fa-times"></i> Close</span>'), ['action' => 'index'], ['escape' => false]
            )
            ?>
        </div>
    </div>
                    ...
                    <div class="tab-container">
                        <div class="nav-tabs-navigation">
                            <div class="nav-tabs-wrapper">
                                <ul class="nav nav-tabs nav-fill pr-0" data-tabs="tabs" id="myTabs" role="tablist">
                                    <li class="nav-item">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" onclick="previewForm();" href="#eform-3" data-toggle="tab">Notifications</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" onclick="previewForm();" href="#eform-4" data-toggle="tab">Preview</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        <div class="tab-content">
                            <div class="tab-pane active" id="eform-1">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8 d-flex align-items-center">
                                                ...
                                                if (
                                                    ...
                                                    $isclientInvitationEform_yes = 'checked';
                                                } elseif (
                                                        $eform->isclientInvitationEform ==
                                                        "no"
                                                ) {
                                                    $isclientInvitationEform_no = 'checked';
                                                }
                                                ?>
                                                <div class="form-check form-check-radio">
                                                    <label class="form-check-label">
                                ...
                                <div class="row justify-content-center align-items-center">
                                    <button type="button" class="btn btn-success next-btn mx-1">Next</button>
                                </div>
                            </div>
        ...
        <?php if ($field_verified == 'yes') { ?>
            ...
            if ($field_verification_grade == 'G') {
                                            ...
                                            <div class="card-footer justify-content-center align-items-center">
                                                <button type="button" class="btn btn-success previous-btn mx-1">Previous</button>
                                                <button type="submit" onclick="saveEform();" class="btn btn-primary mx-1">Save</button>
                                                <button type="button" onclick="removeAllField();" class="btn btn-danger mx-1">Reset</button>
                                                <button type="button" onclick="previewForm();" class="btn btn-success next-btn mx-1">Next</button>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8 d-flex align-items-center">
                                        ...
                                        if (
                                            ...
                                            $additional_notification_yes = 'checked';
                                        } elseif (
                                                $eform->isAdditionalNotification ==
                                                "yes"
                                        ) {
                                            $additional_notification_no = 'checked';
                                        }
                                        ?>
                                        <div class="form-check form-check-radio">
                                            <label class="form-check-label">
                                                <input class="form-check-input additional_notification" type="radio" name="additional_notification" id="additional_notification_yes" value="yes" <?php echo $additional_notification_yes; ?> />
                                                Yes
                                                <span class="circle">
                                                    <span class="check"></span>
                                                </span>
                                        ...
                                        <div class="form-check form-check-radio">
                                            <label class="form-check-label">
                                                <input class="form-check-input additional_notification" type="radio" name="additional_notification" id="additional_notification_no" value="no" <?php echo $additional_notification_no; ?> />
                                                No
                                                <span class="circle">
                                                    <span class="check"></span>
                                                </span>
        ...
        <?php } ?>
                                                            ...
                                                            <div class="form-group col-12">
                                                                ...
                                                                if (
                                                                    ...
                                                                    ?>
                                                                    <label class="form-label">File needs to be verified: <?php echo $field_verified; ?></label>
...
?>
                                ...
                                <div class="row justify-content-center align-items-center">
                                    <button type="button" class="btn btn-success previous-btn mx-1">Previous</button>
                                    <button type="submit" onclick="editEform();" class="btn btn-primary mx-1">Submit</button>
                                </div>
                            </div>                           
                            <!-- tab content ends-->
                        </div>
        ...
        <div class="modal-content">
            ...
            <form class="mb-0" role="form" action="" id="addFieldForm_create" method="POST">
                        ...
                        <div class="input-group row">
                            ...
                            <div class="col-sm-6">                                    
                                <div class="form-check form-check-radio d-flex justify-content-around">
                                    ...
                                    <label class="form-check-label">
                                        <input class="form-check-input" type="radio" name="field_mandate_no" checked id="field_mandate_no_create" value="no" >
                                        No
                                        <span class="circle">
                                            <span class="check"></span>
                                        </span>
                    ...
                    <div class="form-group">
                        <div class="input-group row">
                            ...
                            <div class="col-sm-6">                                    
                                <div class="form-check form-check-radio d-flex justify-content-around">
                                    <label class="form-check-label">
                                        <input class="form-check-input fieldver_create" type="radio" name="fieldver_yes" id="fieldver_yes_create" value="yes" >
                                        Yes
                                        <span class="circle">
                                            <span class="check"></span>
                                        </span>
                                    ...
                                    <label class="form-check-label">
                                        <input class="form-check-input fieldver_create" type="radio" name="fieldver_no" checked id="fieldver_no_create" value="no" >
                                        No
                                        <span class="circle">
                                            <span class="check"></span>
                                        </span>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" id="submit_create" onclick="createForm()">Add</button>
        ...
        <div class="modal-content">
            ...
            <form class="mb-0" role="form" action="" id="addFieldForm" method="POST">
                <div class="modal-body">
                        ...
                        <div class="input-group row">
                            ...
                            <div class="col-sm-6">                                    
                                <div class="form-check form-check-radio d-flex justify-content-around">
                                    ...
                                    <label class="form-check-label">
                                        <input class="form-check-input" type="radio" name="field_mandate_no" checked id="field_mandate_no" value="no" >
                                        No
                                        <span class="circle">
                                            <span class="check"></span>
                                        </span>
                    ...
                    <div class="form-group signature_file">
                        <div class="input-group row">
                            <label class="form-label col-sm-6">Is the Signature required?</label>
                            <div class="col-sm-6">                                    
                                <div class="form-check form-check-radio d-flex justify-content-around">
                                    <label class="form-check-label">
                                        <input class="form-check-input" type="radio" name="field_signature_yes" id="field_signature_yes" value="yes" >
                                        Yes
                                        <span class="circle">
                                            <span class="check"></span>
                                        </span>
                                    ...
                                    <label class="form-check-label">
                                        <input class="form-check-input" type="radio" name="field_signature_no" checked id="field_signature_no" value="no" >
                                        No
                                        <span class="circle">
                                            <span class="check"></span>
                                        </span>
                    ...
                    <div class="form-group">
                        <div class="input-group row">
                            ...
                            <div class="col-sm-6">                                    
                                <div class="form-check form-check-radio d-flex justify-content-around">
                                    <label class="form-check-label">
                                        <input class="form-check-input fieldver" type="radio" name="fieldver_yes" id="fieldver_yes" value="yes" >
                                        Yes
                                        <span class="circle">
                                            <span class="check"></span>
                                        </span>
                                    ...
                                    <label class="form-check-label">
                                        <input class="form-check-input fieldver" type="radio" name="fieldver_no" checked id="fieldver_no" value="no" >
                                        No
                                        <span class="circle">
                                            <span class="check"></span>
                                        </span>
                    ...
                    <div id="fieldverified_yes_no">
                        <div class="input-group row">
                            <label class="form-label col-sm-6">What grade?</label>
                            <div class="col-sm-6">
                                <select class="form-control" id="verification_grade" data-default="">
                                    <option value="">Select Grade</option>
                                    <option value="G">Government</option>
                                    <option value="F">Financial</option>
                                    <option value="T">Telecom</option>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" id="submit" onclick="addeForm()">Add</button>
                    <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
                </div>
            </form>
        </div>
