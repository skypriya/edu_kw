                ...
                <div class="card-body">
                    <div class="table-responsive m-t-10">                        
                        ...
                        <div class="row float-right m-0">
                            <h4><?php echo $this->Html->link(__('<i class="fas fa-arrow-circle-left"></i>'), ['action' => 'teacherList'], ['class' => 'btn waves-effect waves-light btn-info', 'escape' => false, 'data-toggle' => "tooltip", 'title'=>'Back']) ?></h4>
                        </div>
                        <table id="teacher_recyle" class="table table-hover table-striped table-bordered">
                            <thead>
                                <tr>
                                    <th>ID</th>
                                 ...
                                 <?php $k = 0; foreach ($users as $user): ?>
                                    <?php $user_id = ConnectionManager::userIdEncode($user['id']); ?>
                                     <tr>
                                        ...
                                        <td>
                                            <?= $this->Html->link(__($user['name']), ['action' => 'view-teacher', $user_id], ['escape' => false]) ?> 
                                        </td>                                        
                                        <td><?= h($user['email']) ?></td>
                                        ...
                                        <td class="actions">
                                            <div class="actions-div">
                                                ...
                                                <?php if (in_array('Admin',$session_usertype)) { ?>  
                                                <?= $this->Html->link(__('<i class="fa fa-undo"></i>'), ['action' => 'restore', $user_id], ['escape' => false, 'data-toggle' => "tooltip", 'title'=>'Restore', 'class' => 'delete_btn', 'data-link' => 'remove_btn' . $user_id, 'style' => 'display:none;']) ?> 
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-sm">
        <div class="modal-content">
            <div class="modal-body">
                <p class="text-center">Are you sure you want to restore this academic personnel user?</p>
            </div>
...
function searchUserType(){
    ...
    document.location.href = burl + '/users/teacher-recycle?s=' + strUserType;
}
</script>
