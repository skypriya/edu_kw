...
<div class="message error hidden idcard_message" onclick="this.classList.add('hidden')"></div>
            ...
            <div class="card card-outline-info">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <h4 class="m-b-0 text-white d-flex align-items-center"><i class="fal fa-chalkboard-teacher mr-1"></i>Edit <?php echo $label; ?> ( <?php echo $user->name; ?> ) </h4>
                ...
                <div class="card-body">
                    ...
                    <div class="form-body">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <?php
                                        ...
                                        echo $this->Form->input('gender', array('type' => 'select', 'options' => $type, 'label' => ['text'=>'Gender', 'class'=>'required'], 'class' => 'form-control custom-select'));
                                    ?>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div>
                                        <select name="nationality" id="nationality"
                                            class="custom-select input-md blurclass">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="font-400">Academic Personal Type</label>
                                    <div>
                                        <select class="custom-select" id="academic_personal_type"
                                            name="academic_personal_type">
                                            <option value="">Academic Personal Type</option>
                                            <?php
                                            foreach ($academicList as $key => $academicLists) {
                                                $selected = '';
                                                if ($academicLists->id == $user->academic_personal_type) {
                                                    $selected = 'selected';
                                                }
                                                ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-10 d-flex align-items-center">
                                ...
                                ?>
                                <div>
                                    <input class="with-gap radio-col-light-blue" type="radio" name="active"
                                        id="active_yes" value="yes" <?php echo $checked_yes; ?> />
                                    <label for="active_yes">Yes</label>
                                </div>
                                <div class="ml-2">
                                    <input class="with-gap radio-col-light-blue" type="radio" name="active"
                                        id="active_no" value="no" <?php echo $checked_no; ?> />
                        ...
                        <div class="form-actions text-right">
                            ...
                            <?= $this->Html->link(__('<i class="fas fa-times mr-1"></i> Close'), ['action' => 'teacherList', $user_id], ['escape' => false, 'class'=>'btn waves-effect waves-light btn-danger']) ?>
                            <?php } else if (in_array('Teacher',$get_usertype)) { ?>
                            <?= $this->Html->link(__('<i class="fas fa-times mr-1"></i> Close'), ['action' => 'teacherList'], ['escape' => false, 'class'=>'btn waves-effect waves-light btn-danger']) ?>
                            <?php } ?>
                        </div>
                        <?php } ?>
                    ...
                    <div class="row">
                        ...
                        <?php if(in_array('Admin',$session_usertype)) { ?>
                        <div class="col-10 d-flex align-items-center">
                            <?= $this->Html->link('<i class="fas fa-plus fa-2 mr-1"></i> Add Document', ['controller' => 'Docs', 'action' => 'add', $user->id], ['escape' => false, 'class' => 'adddoc btn waves-effect waves-light btn-info']); ?>
                        </div>
                        <?php } ?>
                    </div>
                                ...
                                <tr>
                                    ...
                                    <td class="actions">
                                        <div class="actions-div">
                                            ...
                                            <?= $this->Html->link(__('<i class="fa fa-trash red-txt mx-1"></i>'), ['controller' => 'Docs', 'action' => 'delete', $tids, $user->id], ['escape' => false, 'data-toggle' => "tooltip", 'title'=>'Remove', 'class' => 'delete_btn', 'data-link' => 'remove_btn' . $tids]) ?>

                                            <?= $this->Form->postLink(__('Delete'), ['controller' => 'Docs', 'action' => 'delete', $tids, $user->id], ['escape' => false, 'id' => 'remove_btn' . $tids, 'style' => 'display:none;']) ?>

                                            <button href="javascript:void(0);" data-type="document"
                                                data-title="<?php echo $tids; ?>"
                                                onclick="sendModalModule('<?php echo $tids; ?>');"
                                                class="btn btn-sm waves-effect waves-light btn-info mx-1">Send</button>

                                            <button href="javascript:void(0);" data-title="<?php echo $tids; ?>"
                                                onclick="viewSendDocumentModalModule('<?php echo $tids; ?>');"
                                                class="btn btn-sm waves-effect waves-light btn-info mx-1">View
                                                Sent</button>
                                ...
                                <tr>
                                    ...
                                    <td class="actions">
                                        <div class="actions-div">
                                            ...
                                            <button href="javascript:void(0);" data-title="<?php echo $td; ?>"
                                            ...
                                            <button href="javascript:void(0);" data-title="<?php echo $td; ?>"
                                                ...
                                                class="viewSendIDCardModalModule btn btn-sm waves-effect waves-primary btn-info mx-1">View
                                                Sent</button>

                                            <button href="javascript:void(0);" data-title="<?php echo $td; ?>"
                                                onclick="viewReceivedIDCardModalModule('<?php echo $td; ?>', 'idcard');"
                                                class="viewReceivedIDCardModalModule btn btn-sm waves-effect waves-primary btn-info mx-1">View
                                                Received</button>
                ...
                <div class="modal-body">
                    <fieldset>
                        ...
                        <label class="required">Document Type</label>
                            <select name="fk_documenttype_id" id="fk_documenttype_id"
                                class="custom-select input-md blurclass" required>
                        ...
                        <div>
                            <?php echo $this->Form->input('attachs', array('type' => 'file', 'label' => ['text'=>'Attach a file', 'class'=>'required'], 'required' => 'true')); ?>
                        </div>
                ...
                <div class="modal-body" id="contentBodyIDCard">
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" id="expiry_date_popup_doc" name="idCardExpiyDateDoc" class="form-control"
                                format="YYYY-MM-DD" placeholder="Date of Birth" min="<?php echo date("Y-m-d"); ?>" value="<?php echo $idCardExpiyDate; ?>"
                                required />
                        </div>
                        <!--                        <div>
                        ...
                        <input type="hidden" id="c" name="c"
                            value="<?php echo ConnectionManager::userIdEncode('Teacher'); ?>" />
                    </fieldset>
                </div>
                <div class="modal-footer">
                    <?= $this->Form->button(__('Submit'), array('class' => 'btn btn-primary')) ?>
...
<!-- Send Modal -->
<div class="modal " id="sendModalModule" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            <form role="form"  id="SendDoc" method="POST" class="mb-0">
                ...
                <div class="d-flex align-items-center justify-content-around">
                    ...
                    <div>
                        ...
                        <div class="form-group phone mb-0 list_wrapper">
                            <div class="form-row align-items-center">
                                ...
                                <div class="col-1 text-center">
                                    <a href="javascript:void(0);"><i class="fa fa-plus btn-action"
                                            onclick="list_add_button()" aria-hidden="true"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
