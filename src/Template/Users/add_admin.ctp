        ...
        <div class="col-lg-9 col-xlg-9">            
            <div class="card card-outline-info">
                <div class="card-header">
                    <div class="row">
                        <div class="col-6">
                            <h4 class="m-b-0 text-white"><i class="fal fa-users-crown mr-1"></i>Add Admin</h4>
                        </div>
                ...
                <?= $this->Form->create($user,array('id'=>'add-user')) ?>
                    <input type="hidden" id="ut" name="ut" value="Admin"/>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="student_dob" name="dob" class="form-control" placeholder="Date of Birth" max="<?php echo date("Y-m-d"); ?>" required value="<?php echo $user->dob; ?>" />
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                    ...
                    <div class="form-actions text-right">
                        ...
                        <?= $this->Html->link(__('<i class="fas fa-times mr-1"></i> Close'), ['action' => 'adminList'], ['class' => 'btn waves-effect waves-light btn-danger', 'escape' => false]) ?>
                    </div>
                <?php } ?>
        ...
        <div class="modal-content">
            <form id="getDataFROMData" method="POST" class="mb-0">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn waves-effect waves-light btn-primary" onclick="getDataFROMData('admin')">Request Data</button>
