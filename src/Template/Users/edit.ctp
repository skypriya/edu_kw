            ...
            <div class="card card-outline-info">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <h4 class="m-b-0 text-white d-flex align-items-center"><i class="fal fa-user-graduate mr-1"></i> Edit <?php echo $label; ?> (
                            <?php echo $user->name; ?> ) </h4>
                        <?= $this->Html->link(__('<i class="fas fa-arrow-circle-left"></i> '),'users',  ['class' => 'btn waves-effect waves-light btn-info','escape' => false, 'data-toggle' => "tooltip", 'title'=>'Back']) ?>
                    </div>
                </div>
                <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="student_dob" name="dob" class="form-control" placeholder="Date of Birth"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="nationality" id="nationality" class="form-control custom-select"
                                        data-placeholder="Select Country" tabindex="1">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="adminssion_date" name="adminssion_date" class="form-control"
                                        placeholder="Admission Date" value="<?php 
                                        $adate = date("d-m-Y", strtotime($user->adminssion_date));
                                        if($adate !== '01-01-1970' ) {
                                            echo $adate;
                                        } ?>" />
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <?php
                                        ...
                                        ?>
                                    <select class="custom-select" id="courses" name="courses">
                    ...
                    <div class="form-actions text-right">
                        ...
                        <?php } else if (in_array('Admin',$get_usertype)) { ?>

                        <?= $this->Html->link(__('<i class="fas fa-times mr-1"></i> Close'), ['action' => 'view', $user_id], ['escape' => false, 'class' => 'btn waves-effect waves-light btn-danger']) ?>
                        ...
                        <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $user_id], ['escape' => false, 'id' => 'remove_btn', 'style' => 'display:none;', 'class' => 'btn waves-effect waves-light btn-danger d-none']) ?>
                ...
                <div class="modal-body">
                    <div class="d-flex align-items-center justify-content-around"> 
                        <div>
                            ...
                            <label for="viewSendIDCardinlineRadio3">Email</label>
                        </div>
                        <div>
