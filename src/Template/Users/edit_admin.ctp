            ...
            <div class="card card-outline-info">
                ...
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <h4 class="m-b-0 text-white d-flex align-items-center"><i class="fal fa-users-crown mr-1"></i>Edit <?php echo $label; ?> (
                ...
                <div class="card-body">
                    ...
                    <?php if(in_array('Admin',$session_usertype)) { ?>
                        <div class="form-actions text-right">
                            ...
                            <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $user_id], ['escape' => false, 'id' => 'remove_btn', 'style' => 'display:none;', 'class' => 'btn waves-effect waves-light btn-danger']) ?>
                            ...
                            <?= $this->Html->link(__('<i class="fas fa-times mr-1"></i> Close'), ['action' => 'adminList', $user_id], ['escape' => false, 'class' => 'btn waves-effect waves-light btn-danger']) ?>
