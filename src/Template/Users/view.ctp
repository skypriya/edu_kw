                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="button-group text-right">
                            <?php if (in_array('Admin',$session_usertype)) { ?>
                                ...
                                <?= $this->Html->link(__('<i class="fa fa-edit mr-1"></i> Edit'), ['action' => 'edit', $user_id], ['escape' => false, 'class' => 'btn waves-effect waves-light btn-success']) ?>

                                <?= $this->Html->link(__('<i class="fa fa-trash mr-1"></i> Delete'), ['action' => 'delete', $user_id], ['escape' => false, 'class' => 'delete_btn btn waves-effect waves-light btn-success', 'data-link' => 'remove_btn']) ?>
        ...
        <div class="col-lg-9">
            <div class="card card-outline-info">
                <div class="card-header">
                    <h4 class="m-b-0 text-white d-flex align-items-center"><i class="fal fa-user-graduate mr-1"></i>View <?php echo $label; ?> (
        ...
        <div class="modal-content">
            ...
            <form method="post" accept-charset="utf-8" id="adddoc" controller="Doc" action="<?php echo PATH_URL_PREFIX; ?>/docs/doc-genrate">
                <div class="modal-body">
                    <div class="form-body">
                        <div class="form-group">
                            <?php echo $this->Form->input('name', array('label' => ['text'=>'Document', 'class'=>'required'], 'class' => 'form-control', 'required' => 'true')); ?>
                        </div>
                        <div class="form-group">
                        ...
                        <div>
                            <?php echo $this->Form->input('attachs', array('type' => 'file', 'label' => ['text'=>'Attach a file', 'class'=>'required'], 'class' => 'form-control','required' => 'true')); ?>
                        </div>
