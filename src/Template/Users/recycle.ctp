                ...
                <div class="card-body">
                    <div class="table-responsive m-t-10">
                        ...
                        <div class="row float-right m-0">
                            <h4><?php echo $this->Html->link(__('<i class="fas fa-arrow-circle-left"></i>'), ['action' => 'index'], ['class' => 'btn waves-effect waves-light btn-info', 'escape' => false, 'data-toggle' => "tooltip", 'title'=>'Back']) ?></h4>
                        </div>
                        <table id="student_recyle" class="table table-hover table-striped table-bordered">
                            <thead>
                                <tr>
                                    <th>ID</th>
                                ...
                                <tr>
                                    ...
                                    <td class="actions">
                                        <div class="actions-div">
                                            ...
                                            <?php if (in_array('Admin',$session_usertype)) { ?>
                                            <?= $this->Html->link(__('<i class="fa fa-undo green-txt"></i>'), ['action' => 'restore', $user_id], ['escape' => false, 'data-toggle' => "tooltip", 'title'=>'Remove', 'class' => 'delete_btn', 'data-link' => 'remove_btn' . $user_id, 'style' => 'display:none;']) ?>
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-sm">
        <div class="modal-content">
            <div class="modal-body">
                <p class="text-center">Are you sure you want to restore this student user?</p>
            </div>
...
function searchUserType(){
    ...
    document.location.href = burl + '/users/recycle?s=' + strUserType;
}
</script>