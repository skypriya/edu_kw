                ...
                <div class="card-body">
                    <div class="table-responsive m-t-10">
                        ...
                        <div class="row float-right m-0">
                            <h4><?php echo $this->Html->link(__('<i class="fas fa-arrow-circle-left"></i>'), ['action' => 'adminList'], ['class' => 'btn waves-effect waves-light btn-info', 'escape' => false, 'data-toggle' => "tooltip", 'title'=>'Back']) ?>
                        </div>
                        <table id="admin_recyle" class="table table-hover table-striped table-bordered">
                            <thead>
                                <tr>
                                    <th>ID</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?= $this->Html->link(__($user['name']), ['action' => 'view-admin', $user_id], ['escape' => false, 'data-toggle' => "tooltip", 'title'=>'View']) ?>
                                    </td>
                                    <td><?= h($user['email']) ?></td>
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-sm">
        <div class="modal-content">
            <div class="modal-body">
                <p class="text-center">Are you sure you want to restore this admin user?</p>
            </div>
...
function searchUserType(){
    ...
    document.location.href = burl + '/users/admin-recycle?s=' + strUserType;
}
