                ...
                <div class="card-body">           
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="button-group text-left">                        
                            <?= $this->Html->link(__('<i class="fas fa-arrow-circle-left"></i> '),'users/admin-list',  ['class' => 'btn waves-effect waves-light btn-info','escape' => false, 'data-toggle' => "tooltip", 'title'=>'Back']) ?>
                        </div>     
                        <div class="button-group text-right">
                            <?php if($soft_delete == 0) { ?>
                            
                                <?= $this->Html->link(__('<i class="fas fa-edit mr-1"></i> Edit'), ['action' => 'editAdmin', $user_id], ['escape' => false, 'class' => 'btn waves-effect waves-light btn-success']) ?>
        ...
        <div class="col-lg-9"> 
            <div class="card card-outline-info">
                <div class="card-header">
                    <h4 class="m-b-0 text-white d-flex align-items-center"><i class="fal fa-users-crown mr-1"></i>View <?php echo $label; ?> ( <?php echo $user->name; ?> ) </h4>
                </div>
                <div class="card-body">
