...
$stafflist_name = '';
if (isset($user->staff_type) && $user->staff_type != "") {
    $query_data = $conn->execute('SELECT * FROM stafflist where id=' . $user->staff_type);
                    ...
                    <div class="card-body">        
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <?php if($soft_delete == 0) { ?>
                                <?= $this->Html->link(__('<i class="fa fa-edit mr-1"></i> Edit'), ['action' => 'edit-staff', $user_id], ['escape' => false, 'class' => 'btn waves-effect waves-light btn-success']) ?>

                                <?= $this->Html->link(__('<i class="fa fa-trash mr-1"></i> Delete'), ['action' => 'delete', $user_id], ['escape' => false, 'class' => 'delete_btn btn waves-effect waves-light btn-warning', 'data-link' => 'remove_btn']) ?>
                            ...
                            <?php 
                                $page_name = "staffList";
                                if($soft_delete == 1) {
                                    $page_name = "staff-recycle";
                                }
                            ?>
                            <?php if (in_array('Admin',$get_usertype)) { ?>
                                <?= $this->Html->link(__('<i class="fa fa-times mr-1"></i> Close'), ['action' => $page_name, $user_id], ['escape' => false, 'class' => 'btn waves-effect waves-light btn-danger']) ?>
                            <?php } else if (in_array('Staff',$get_usertype)) { ?>
                                <?= $this->Html->link(__('<i class="fa fa-times mr-1"></i> Close'), ['action' => $page_name], ['escape' => false, 'class' => 'btn waves-effect waves-light btn-danger']) ?>
                            <?php } ?>
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-lg-9">            
            <div class="card card-outline-info">
                <div class="card-header">
                    <h4 class="m-b-0 text-white d-flex align-items-center"><i class="fal fa-users mr-1"></i>View <?php echo $label; ?> ( <?php echo $user->name; ?> ) </h4>
                </div>
                <div class="card-body">
                    ...
                    <div class="form-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="font-400"><?= __('Staff Type') ?></label>
                                    <div><?= h($stafflist_name); ?></div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                                        ...
                                        <tr>
                                            ...
                                            <td class="actions">
                                                <div class="actions-div">
                                                    ...
                                                    <button type="button" class="btn btn-sm waves-effect waves-light btn-info viewReceivedDocumentModalModule" data-title="<?php echo $tids; ?>" onclick="viewReceivedDocumentModalModule('<?php echo $tids; ?>');">View Received</button>                                                
                                                </div>
                                            </td>
                                            <?php } ?>
                                        </tr>
                                    ...
                                    <div class="col-10 d-flex align-items-center">
                                        <?php if($soft_delete == 0) { ?>
                                            <?php if($check_fields == 0) { ?>
                                                <?= $this->Html->link(__('<i class="fa fa-plus fa-2 mr-1"></i> Create ID Card'), ['controller' => 'Docs', 'action' => 'addidcard', $user_id], ['class' => 'addidcard btn waves-effect waves-light btn-info', 'escape' => false]); ?>
                                            <?php } else { ?>
                                                <a href="#scroll" id="checkidcard" class="btn waves-effect waves-light btn-info" > <i class="fa fa-plus fa-2 mr-1"></i> Create ID Card
                                                </a>                         
                                            <?php } ?>
                                        <?php } ?>
                                    </div>
                                        ...
                                        <?php if (in_array('Admin',$get_usertype)) { ?>  
                                            <td class="actions">
                                                <div class="actions-div">
                                                    ...
                                                    <button type="button" class="btn btn-sm waves-effect waves-primary btn-info viewReceivedIDCardModalModule" data-title="<?php echo $td; ?>" onclick="viewReceivedIDCardModalModule('<?php echo $td; ?>', 'idcard');">View Received</button>
                                                </div>
                                            </td>
                                        <?php } ?>
                                    <?php } ?>
            ...
            <form method="post" accept-charset="utf-8" id="addidcard" controller="IDCard" action="<?php echo PATH_URL_PREFIX; ?>/i-d-card/pdf-genrate">
                <div class="modal-body" id="contentBodyIDCard">
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            <label class="font-400 required">ID Card Expiry Date</label>
