...
<html lang="en">
    <head>
        ...
        <!-- Editable CSS -->
        <?= $this->Html->css('../new-assets/plugins/jsgrid/dist/jsgrid.min.css') ?>
        <?= $this->Html->css('../new-assets/plugins/jsgrid/dist/jsgrid-theme.min.css') ?>
        <!-- Custom CSS -->
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right scale-up">
                                <ul class="dropdown-user">                                    
                                    ...
                                    <li>                                        
                                        <?= $this->Html->link('<i class="ti-settings"></i> Update', array('controller' => 'Users', 'action' => 'view', $user_id), array('escape' => false)); ?>
                                    </li>
                                    <?php } ?>
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="nav-item <?php
                            ...
                            ?>">            
                                <?= $this->Html->link('<i class="fal fa-user-graduate"></i><span class="hide-menu">My Profile</span>', array('controller' => 'Users', 'action' => 'index'), array('class' => 'waves-effect waves-dark', 'escape' => false)); ?>
                        </li>
                        <?php } else if(in_array('Staff',$session_usertype)) { ?>
                        <li class="nav-item  <?php
                        ...
                        <li class="nav-item  <?php
                            if ($contr == 'Sclasses') {
                                ...
                                ?>">    
                            <?= $this->Html->link('<i class="fal fa-users-class"></i><span class="hide-menu">Class Attendance</span>', array('controller' => 'Sclasses', 'action' => 'index'), array('class' => 'waves-effect waves-dark', 'escape' => false)); ?>
                        </li>
                        <li class="nav-item <?php
                        ...
                        <li class="nav-item  <?php
                             ...
                             <li class="nav-item  <?php
                                if ($contr == 'Management') {
                                    ...
                                    ?>">            
                                <?= $this->Html->link('<i class="fal fa-user"></i><span class="hide-menu">Users Type</span>', array('controller' => 'Management', 'action' => 'index'), array('class' => 'waves-effect waves-dark', 'escape' => false)); ?>
                             </li>
    ...
    <?= $this->Html->link('<i class="fal fa-user-graduate"></i><span class="hide-menu">Students</span>', array('controller' => 'Users', 'action' => 'index'), array('class' => 'waves-effect waves-dark', 'escape' => false)); ?>
                            ...
                            <li class="nav-item  <?php
                                ...
                                ?>">            
                            <?= $this->Html->link('<i class="fab fa-wpforms"></i><span class="hide-menu">eForms Response</span>', array('controller' => 'EformResponse', 'action' => 'index'), array('class' => 'waves-effect waves-dark', 'escape' => false)); ?>
                            </li>
  ...
  <?= $this->Html->script('../new-js/custom.min.js') ?>   
   ...
   <?= $this->Html->script('../new-assets/plugins/jsgrid/dist/jsgrid.min.js') ?>
  ...
  <!--Custom Created JS -->
   ...
   <?= $this->Html->script('../new-assets/plugins/morrisjs/morris.min.js') ?>
    ...
    <?php if (($contr == 'Sclasses' || $contr == 'Gates') && $act == 'view') { ?>
