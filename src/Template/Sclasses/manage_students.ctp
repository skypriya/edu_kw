                ...
                <div class="card-body">
                   <div class="table-responsive m-t-10">
                       <div class="row float-right m-0">
                                               <?php
                                                if((in_array('Admin',$session_usertype) || in_array('Teacher',$session_usertype)) && ($sclass->userallow > $allcount)){
                        ...
                        <div class="button-group text-right">
                            <?= $this->Html->link(__('<i class="fas fa-plus mr-1"></i> Add Student'), ['action' => 'addStudents', $sclassid], ['class' => 'btn waves-effect waves-light btn-primary','escape' => false]) ?>
                        </div>
    <?php } ?>    
                    </div>
    ...
    <div class="modal-dialog modal-dialog-centered modal-sm">
        <div class="modal-content">
            <div class="modal-body">
                <p class="text-center">Are you sure you want to delete this student from class?</p>
            </div>
