                    ...
                    <div class="form-body">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <?php echo $this->Form->input('name', array('label' => 'Name', 'class' => 'form-control', 'value' => $sclasses->name)); ?>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <?php echo $this->Form->input('userallow', array('label' => 'Maximum number of students', 'class' => 'form-control', 'value' => $sclasses->userallow)); ?>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="list_wrapper">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Academic Personnel</label>
                                        <select name="fk_user_id" id="fk_user_id" class="custom-select input-md blurclass">
                                            ...
                                            foreach ($users as $user) {
                                                $selected = "";
                                                if($sclasses->fk_user_id == $user['id']) {
                                                    $selected = "selected";
                                                }
                                                ?>
