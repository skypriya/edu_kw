                                ...
                                <div class="col-md-12">
                                    <div class="form-group container mt-5">
                                       <!-- <label>Students </label> -->
                                        <select name="users[]" required="required" class="js-example-placeholder-multiple js-states form-control" multiple="multiple" id="manage_users_multiple" size="5" style="height:auto;">
                                            <?php 
                                                foreach ($users as $c){ 
...
$(document).ready(function () {
    $( "#manage_users_multiple" ).change(function() {
                    alert('checked');
