...
//                     return $this->response;
    ...
    public function register($from = null) {
        ...
        $cncode = $_REQUEST['country'];
        if($cncode!=""){
            $callingcode_query   = 'SELECT calling_code  FROM countries where id = '.$cncode;
            $query_callingcode       = $conn->execute($callingcode_query);
            $location_query_response = $query_callingcode->fetch('assoc');
            $calling_code =$location_query_response['calling_code'];
        }
        ...
        if ($this->request->is('post')) {
            ...
            $user->akcessId = $aid;
            $user->mobileNumber = $p;
            $user->country = $calling_code;
         //   $user->country_code = $calling_code;
        ...
        $this->set(compact('user', 'data_rerponse', 'data_rerponse_encode','countries'));
        if ($from == 'login') {
            $this->render('login');
        }
    }
