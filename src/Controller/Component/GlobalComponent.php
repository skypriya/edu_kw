...
class GlobalComponent extends Component {
    ...
    public function curlGetPost($method, $type, $api, $origin_url, $api_url, $data = array(), $origin = array()) {
        ...
        $response = '';
        //echo "'".$data."'";
//echo '<pre>'.$api_url . $type . $urlencode;print_r($data);die;
    ...
    public function getVerifyDoc($data) {
        ...
        $AKcessToken = $this->getToken();
        $type = 'document/docVerify';

        // $fileNameHash = $data['fileNameHash'];
        // $akcessIdHash = $data['akcessIdHash'];
        // $data_array = array(
        //     'documentId' => $data['documentID'],
        //     'documentHash' => '["' . $fileNameHash . '","' . $akcessIdHash . '"]',
        //     'akcessId' => $data['verifierAkcessId'],
        //     "filename" => $data['fileName_ak'],
        //     "filedata" => $data['akData'],
        //     'device_token' => $AKcessToken,
        // );
        ...
        $data_array = array(
            ...
            'documentId' => $data['documentID'],
            'verifierAkcessId' => $data['verifierAkcessId'],
            'expiryDate' => $data['expiryDate'],
            'authorization' => $AKcessToken,
            'apikey' => $api,
            "fileName" => $data['fileName_ak'],
            "akData" => $data['akData'],
            'userAkcessId' => $data['verifierAkcessId'],
            'sessionId' => 'sessionId',
        );
